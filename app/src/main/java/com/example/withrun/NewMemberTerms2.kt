...
class NewMemberTerms2 : AppCompatActivity() {

    private var location = ""

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_new_member_terms2)
        ...
        val `is`: InputStream = this.resources.openRawResource(R.raw.terms2)
